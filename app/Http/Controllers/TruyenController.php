...
class TruyenController extends Controller
{
    ...
    public function handle(Truyen $truyen)
    {
        $truyen->increment('views');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate(
            [
            'tentruyen' =>  ['required',Rule::unique('truyen')->ignore($truyen->id, 'id')],
        ...
        [
            'tentruyen.unique'=>'Trùng tên truyện!',
            'tentruyen.required'=>'Không được để trống tên truyện!',
            'slug_truyen.required'=>'Slug truyện không thể trống!',
            'tomtattruyen.required'=>'Không được để trống phần mô tả!',
           /*  'hinhanh.required'=> 'Hình ảnh phải có!' */
           ...
           'danhmuc.required'=> 'Danh mục phải có!'
        ]
    );
    ...
    public function details_truyennoibat($id,request $request){
        $truyen = Truyen::where('truyen_id',$id)->first();

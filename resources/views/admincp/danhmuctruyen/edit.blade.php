        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{route('danhmuc.update',[$danhmuc -> id])}}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="motadanhmuc" value="{{$danhmuc->motadanhmuc}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục...">

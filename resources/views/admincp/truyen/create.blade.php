                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('truyen.store')}}" enctype='multipart/form-data'>
                      ...
                      <div class="form-check">
                          ...
                          <input class="form-check-input" name="danhmuc[]" type="checkbox" id="danhmuc_{{$danh->id}}" value="{{$danh->id}}">
                          <label class="form-check-label" for="danhmuc_{{$danh->id}}">{{$danh->tendanhmuc}}</label>

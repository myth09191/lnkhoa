            ...
            <div class="card">
                ...
                <form action="{{url('/insert_permission',[$user->id])}}" method="POST">
                    ...
                    <div class="form-check">
                        ...
                        @endif
                        @endforeach
                        name="permission[]" value="{{$p->id}}" id="{{$p->id}}">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
            <form  method="POST" action="{{url('insert_permission')}}">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Tên quyền</label>
                            <input type="text" class="form-control" value="{{old('permission')}}" name="permission" placeholder="Tên permission...">

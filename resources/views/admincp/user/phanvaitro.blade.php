        ...
        <div class="col-md-8">
            ...
            <form  method="POST" action="{{url('insert_roles')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{old('role')}}" name="role" placeholder="Tên role...">

                        </div>
                        <input type="submit" name="insertroles" value="Thêm vai trò" class="btn btn-success">
                    </form>
